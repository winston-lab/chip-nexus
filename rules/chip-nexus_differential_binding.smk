...
rule differential_binding:
    ...
    output:
        ...
        results_changed = "diff_binding/{annotation}/{condition}-v-{control}/{norm}/{condition}-v-{control}_{factor}-chipnexus-{norm}-{annotation}-diffbind-results-unchanged.tsv",
