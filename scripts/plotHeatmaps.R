...
hmap = function(df, nindices, ylabel, upstream, dnstream, refptlab, cmap, factor){
...
main = function(intable, samplelist, upstream, dnstream, pct_cutoff,
                cluster, k, refptlab, factor, ylabel, cmap, samples_out, group_out){
...
main(intable= 'allsamples-rhee2012cleaned-tfiib-chipnexus-libsizenorm-qfrags.tsv.gz',
     samplelist = c("WT-37C-1","WT-37C-2","spt6-1004-37C-1","spt6-1004-37C-2"),
     upstream = 30,
     dnstream= 120,
     pct_cutoff = 0.90,
     cluster = TRUE,
